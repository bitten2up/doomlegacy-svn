...
//-----------------------------------------------------------------------------
//
// $Id: info.c 1681 2024-03-20 22:48:29Z wesleyjohnson $
//
...
// MBF
    ...
    { SPR_MISL,32768, 1000, {A_Die_MBF},      S_GRENADE},   // S_GRENADE

    // killough 8/10/98: variable damage explosion
    { SPR_MISL,32769,    4, {A_Scream},   S_DETONATE2}, // S_DETONATE
    { SPR_MISL,32770,    6, {A_Detonate_MBF}, S_DETONATE3}, // S_DETONATE2
    ...
    { SPR_MISL,32769,    8, {A_Mushroom_MBF}, S_EXPLODE2},  // S_MUSHROOM
...
#ifdef MBF21
    // [WDJ] MBG21 moved hardcoded tests into info table.

...
//-----------------------------------------------------------------------------
//
// $Id: info.h 1674 2024-03-03 04:41:20Z wesleyjohnson $
//
...
#endif
  // void       (*action) ();
  actionf_t     action;  // action function
...
# define MAX_NUM_STATE_ARGS   8
    int32_t    args[MAX_NUM_STATE_ARGS];  // MBF21 parameters
# define  parm1  args[0]
# define  parm2  args[1]
#else
...
#ifdef MBF21
    // These are all 0 unless specially set.
    uint16_t  melee_range;  // DSDA meleerange
